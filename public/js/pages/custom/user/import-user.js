...
// Class Definition
var KTImportUser = function() {
    //var _login;

    var _handleImportUserForm = function(e) {
        var validation;
        var form = KTUtil.getById('importUser');
        ...
        $('#ImportUserButton').on('click', function (e) {
            e.preventDefault();
