...
// Class Definition
var KTImportVillage = function() {
    //var _login;

    var _handleImportVillageForm = function(e) {
        var validation;
        var form = KTUtil.getById('importVillage');
        ...
        $('#ImportVillageButton').on('click', function (e) {
            e.preventDefault();
    ...
    return {
        ...
        init: function() {
            //_login = $('#kt_login');
            _handleImportVillageForm();
        }
    };
}();
// Class Initialization
jQuery(document).ready(function() {
    KTImportVillage.init();
	//KTUserEdit.init();
});
