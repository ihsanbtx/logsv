...
// Class Definition
var KTImportSVOP = function() {
    //var _login;

    var _handleImportSVOPForm = function(e) {
        var validation;
        var form = KTUtil.getById('importSVOP');
        ...
        $('#ImportSVOPButton').on('click', function (e) {
            e.preventDefault();
