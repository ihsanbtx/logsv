...
// Class Definition
var KTImportSubdistrict = function() {
    //var _login;

    var _handleImportSubdistrictForm = function(e) {
        var validation;
        var form = KTUtil.getById('importSubdistrict');
        ...
        $('#ImportSubdistrictButton').on('click', function (e) {
            e.preventDefault();
    ...
    return {
        ...
        init: function() {
            //_login = $('#kt_login');
            _handleImportSubdistrictForm();
        }
    };
}();
// Class Initialization
jQuery(document).ready(function() {
    KTImportSubdistrict.init();
	//KTUserEdit.init();
});
