...
// Class Definition
var KTImportActivity = function() {
    //var _login;

    var _handleImportActivityForm = function(e) {
        var validation;
        var form = KTUtil.getById('importActivity');
        ...
        $('#ImportActivityButton').on('click', function (e) {
            e.preventDefault();
    ...
    return {
        ...
        init: function() {
            //_login = $('#kt_login');
            _handleImportActivityForm();
        }
    };
}();
// Class Initialization
jQuery(document).ready(function() {
    KTImportActivity.init();
	//KTUserEdit.init();
});
