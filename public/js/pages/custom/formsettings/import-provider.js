...
// Class Definition
var KTImportProvider = function() {
    //var _login;

    var _handleImportProviderForm = function(e) {
        var validation;
        var form = KTUtil.getById('importProvider');
        ...
        $('#ImportProviderButton').on('click', function (e) {
            e.preventDefault();
    ...
    return {
        ...
        init: function() {
            //_login = $('#kt_login');
            _handleImportProviderForm();
        }
    };
}();
// Class Initialization
jQuery(document).ready(function() {
    KTImportProvider.init();
	//KTUserEdit.init();
});
