...
// Class Definition
var KTImportProvince = function() {
    //var _login;

    var _handleImportProvinceForm = function(e) {
        var validation;
        var form = KTUtil.getById('importProvince');
        ...
        $('#ImportProvinceButton').on('click', function (e) {
            e.preventDefault();
    ...
    return {
        ...
        init: function() {
            //_login = $('#kt_login');
            _handleImportProvinceForm();
        }
    };
}();
// Class Initialization
jQuery(document).ready(function() {
    KTImportProvince.init();
	//KTUserEdit.init();
});
