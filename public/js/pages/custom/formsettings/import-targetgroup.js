...
// Class Definition
var KTImportTargetGroup = function() {
    //var _login;

    var _handleImportTargetGroupForm = function(e) {
        var validation;
        var form = KTUtil.getById('importTargetGroup');
        ...
        $('#ImportTargetGroupButton').on('click', function (e) {
            e.preventDefault();
    ...
    return {
        ...
        init: function() {
            //_login = $('#kt_login');
            _handleImportTargetGroupForm();
        }
    };
}();
// Class Initialization
jQuery(document).ready(function() {
    KTImportTargetGroup.init();
	//KTUserEdit.init();
});
