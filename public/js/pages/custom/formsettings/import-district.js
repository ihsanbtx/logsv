...
// Class Definition
var KTImportDistrict = function() {
    //var _login;

    var _handleImportDistrictForm = function(e) {
        var validation;
        var form = KTUtil.getById('importDistrict');
        ...
        $('#ImportDistrictButton').on('click', function (e) {
            e.preventDefault();
    ...
    return {
        ...
        init: function() {
            //_login = $('#kt_login');
            _handleImportDistrictForm();
        }
    };
}();
// Class Initialization
jQuery(document).ready(function() {
    KTImportDistrict.init();
	//KTUserEdit.init();
});
