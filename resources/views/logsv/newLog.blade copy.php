                                                        ...
                                                        <div id="kt_repeater_1">
                                                            <div data-repeater-list="data" class="col-xl-12 col-xxl-10">
                                                                <div data-repeater-item="" class=" mb-20">
                                                                    ...
                                                                    <!--begin::Group
                                                                    <div class="form-group row">
                                                                        <label class="col-form-label col-xl-3 col-lg-3">Choose Video</label>
                                                                        <div class="col-xl-12 col-lg-9 col-form-label">
                                                                            <div class="dropzone dropzone-default dropzone-success" id="kt_dropzone_">
                                                                                <div class="dropzone-msg dz-message needsclick">
                                                                                    <h3 class="dropzone-msg-title">Drop multiple files here or click to upload.</h3>
                                                                                    <span class="dropzone-msg-desc">Only image video files are allowed for upload</span>
                                                                                </div>
                                                                            </div> 
                                                                        </div>
                                                                    </div>
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $('#kt_repeater_1').repeater({
            ...
            /*$.getScript("{{ asset('js/pages/custom/logsv/new-log.js') }}", function() {
                alert('loaded script and content');
            });*/

                //$(this).find('#province').attr('')

                //$(this).find('#latitude').attr({'id': 'latitude'+i});
    ...
    function additem() {
        ...
        var arrayActivity= <?php echo json_encode($activityList); ?>;
        ...
        selectActivity.setAttribute('name', 'activityName['+i+']');
        selectActivity.setAttribute('class', 'form-control ');
        activity.appendChild(selectActivity);

        for(var j=0; j<arrayActivity.length; j++)
        {
            var option=document.createElement("option");
            option.value = arrayActivity[j]["activityName"];
            option.text = arrayActivity[j]["activityName"];
