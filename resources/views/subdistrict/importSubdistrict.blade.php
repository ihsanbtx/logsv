                            ...
                            <div class="card-body p-0">
                                <div class="row justify-content-center py-8 px-8 py-lg-5 px-lg-0">
                                    <div class="col-xl-12 col-xxl-10">
                                        <!--begin::Wizard Form-->
                                            {{ Form::open(['url' => '/doImportSubdistrict', 'id' => 'importSubdistrict', 'enctype'=>'multipart/form-data']) }}
...
<script src="{{asset('js/pages/custom/formsettings/import-subdistrict.js')}}"></script>
<!--end::Page Scripts-->
