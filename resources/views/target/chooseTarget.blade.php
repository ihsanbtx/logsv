										...
										<table class="table table-separate table-head-custom table-checkable" id="kt_target" >
											...
											<tbody>
												...
												<tr>
													...
													<td>{{$data->gender}}</td>
													<td>
                                                        <a href="#detailTargetModal" class="btn btn-sm btn-clean btn-icon mr-2 btn-navi"  title="Details" data-toggle="modal" data-target="#detailTargetModal" id="_id" value="{{$data->_id}}" data-id='{{$data->_id}}'>
                                                            <span class="svg-icon">
